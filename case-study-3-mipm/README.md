# Case Study 1: Estimating species- and community-level demographic rates and population growth 
...
+ `example-data`: contains a set of example data files that were generated during the data simulation. The full set of data generated can be recreated by specifying set.seed(INSERT NUMBER HERE) in SCRIPTNAME.R.
