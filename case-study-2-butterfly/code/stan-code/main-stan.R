# main-stan.R: this script fits the integrated community model for the 
#              butterfly case study using stan, called through the rstan
#              R package.
