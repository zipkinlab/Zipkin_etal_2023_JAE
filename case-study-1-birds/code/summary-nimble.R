...
# Note these files are large and so they are not included on GitHub. 
# These files can be created by running the `main-nimble.R` script and 
# saved in a `results` directory.
load("results/ne-icom-1-chain-2023-01-13.R")
samples.1 <- samples
load("results/ne-icom-2-chain-2023-01-13.R")
samples.2 <- samples
load("results/ne-icom-3-chain-2023-01-13.R")
samples.3 <- samples
...
# Get quantiles of species-specific occurrence
for (i in 1:N) {
